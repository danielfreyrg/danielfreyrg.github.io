...
const answers = ['Hættu þessu væli', 'Það er öllum drullu sama', "Skíttu ekki í þig", "þarf ég að hringja í vælubílinn?", "æjæj, elsku rúsínan mín þú hefur það svo erfitt", "er ekki kominn tími til að líta aðeins í eigin barm einu sinni?", "Á ég að prenta þetta á blað fyrir þig ?", "Þetta var nú ekki fallega sagt, Anna Sigríður mun fá að heyra þetta", "Farðu úr bænum", "heyrðu þú hefur bara rétt fyrir þér", "Djöfulsins læti eru þetta, þarftu ekkert að vinna eða?", "Nei nú hringi ég í jens.", "Væl og tuðningsmálaráðherra var að  hringja og hún kannaðist ekkert við þig"]
